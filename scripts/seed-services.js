...
// Manually parse .env to avoid dotenv dependency issues in some environments
...
const ServiceSchema = new mongoose.Schema({
    ...
    heropromisetitle: String,
    promisedescription: String,
    exploretitile: String,
    explorepoints: {
        points: [String]
    },
...
async function seed() {
    try {
        ...
        console.log(`Seeding completed. ${SERVICES.length} services processed.`);
        process.exit(0);
    } catch (error) {
