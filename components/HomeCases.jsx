                ...
                <div className="js-scroll-block-pin flex absolute h-screen w-full flex-col justify-center">
                    <div className="w-full h-[100%] relative">
                        ...
                        <div className="relative h-screen mr-auto md:px-20 flex items-center justify-center md:w-[60%]">
                            {cases.length > 0 ? (
                                cases.map((item) => (
                                    <div key={item._id} className="js-scroll-block-photo hidden md:block md:absolute md:w-[100%] h-[100%]">
                                ...
                                <div className="hidden md:flex items-center justify-center text-white h-full">No cases found.</div>
                            )}
                        </div>
                    </div>
                    ...
                    <div className="js-scroll-block-content-wrapper js-scroll-block-content-wrapper-bg w-full md:w-[80%] mr-32">
                        {cases.length > 0 ? (
                            cases.map((item, index) => (
                                <div key={item._id} className="js-scroll-block-content">
                                    ...
                                    <div className="mt-4 mb-2 md:mb-8 text-base md:text-lg" style={{ color: '#ffffff' }}>
                                        {String(index + 1).padStart(2, '0')}<span className="opacity-50">/{String(cases.length).padStart(2, '0')}</span>
                                    </div>
                                    <h3
