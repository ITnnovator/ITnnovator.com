...
const STYLES = {
    container: `max-width: 600px; margin: 0 auto; font-family: 'Helvetica Neue', Helvetica, Arial, sans-serif; background-color: #050507; border-radius: 12px; overflow: hidden; border: none; box-shadow: 0 4px 10px rgba(0,0,0,0.1);`,
...
const formatStep3 = (step3) => {
    ...
    for (const [key, val] of Object.entries(step3)) {
        ...
        rows += `
            <tr>
                <td style="padding: 8px 0; width: 160px; vertical-align: top; color: #90a4c2; font-size: 13px; font-weight: 600; text-transform: uppercase; letter-spacing: 0.5px;">${label}</td>
            ...
            <div style="${STYLES.content}">
                ...
                <div style="margin-bottom: 35px;">
                    ...
                    <table width="100%" cellpadding="0" cellspacing="0">
                        <tr>
                            <td style="padding: 8px 0; width: 140px; color: #90a4c2; font-weight: 600; text-transform: uppercase; font-size: 12px;">Full Name</td>
                            <td style="padding: 8px 0; color: ${THEME.heading}; font-weight: 600; font-size: 16px;">${contact.name}</td>
                        </tr>
                        <tr>
                            <td style="padding: 8px 0; width: 140px; color: #90a4c2; font-weight: 600; text-transform: uppercase; font-size: 12px;">Email</td>
                            <td style="padding: 8px 0;"><a href="mailto:${contact.email}" style="${STYLES.link}">${contact.email}</a></td>
                        </tr>
                        <tr>
                            <td style="padding: 8px 0; width: 140px; color: #90a4c2; font-weight: 600; text-transform: uppercase; font-size: 12px;">Phone</td>
                            <td style="padding: 8px 0;"><a href="tel:${contact.phone}" style="${STYLES.link}">${contact.phone}</a></td>
                        </tr>
                        <tr>
                            <td style="padding: 8px 0; width: 140px; color: #90a4c2; font-weight: 600; text-transform: uppercase; font-size: 12px;">Company</td>
                ...
                <div style="margin-bottom: 35px;">
                    ...
                    <p style="margin: 0 0 8px 0; color: #90a4c2; font-size: 12px; font-weight: 700; text-transform: uppercase; letter-spacing: 0.5px;">Selected Features</p>
                    <p style="margin: 0 0 20px 0; color: ${THEME.heading}; line-height: 1.6;">${featuresList}</p>
                    
                    ${projectDetails.otherFeatures ? `
                        <p style="margin: 0 0 8px 0; color: #90a4c2; font-size: 12px; font-weight: 700; text-transform: uppercase; letter-spacing: 0.5px;">Other Custom Features</p>
                    ...
                    ${projectDetails.additionalNotes ? `
                        <p style="margin: 20px 0 8px 0; color: #90a4c2; font-size: 12px; font-weight: 700; text-transform: uppercase; letter-spacing: 0.5px;">Additional Notes</p>
                    ...
                    ${contact.note ? `
                        <p style="margin: 20px 0 8px 0; color: #90a4c2; font-size: 12px; font-weight: 700; text-transform: uppercase; letter-spacing: 0.5px;">User Message (Contact Form)</p>
                 ...
                 <div>
                    <h3 style="${STYLES.sectionTitle}">Timeline & Budget</h3>
                     <table width="100%" cellpadding="0" cellspacing="0">
                        <tr>
                            <td style="padding: 8px 0; width: 140px; vertical-align: top; color: #90a4c2; font-size: 13px; font-weight: 600; text-transform: uppercase;">Timeline:</td>
                             <td style="padding: 8px 0; color: ${THEME.heading}; font-size: 15px;">${timelineLabel}</td>
                        </tr>
                         <tr>
                            <td style="padding: 8px 0; width: 140px; vertical-align: top; color: #90a4c2; font-size: 13px; font-weight: 600; text-transform: uppercase;">Budget:</td>
        ...
        <div style="${STYLES.container}">
            ...
            <div style="${STYLES.content}">
                ...
                <div style="${STYLES.highlightBox}">
                    ...
                    <table width="100%" cellpadding="0" cellspacing="0">
                         <tr>
                            <td style="padding: 6px 0; color: #90a4c2;">Service Type</td>
                            <td style="padding: 6px 0; text-align: right; color: ${THEME.heading}; font-weight: 700;">${typeLabel}</td>
                        </tr>
                        <tr>
                            <td style="padding: 6px 0; color: #90a4c2;">Est. Cost Range</td>
                ...
                <div style="background-color: #0a0a0c; padding: 25px; border-radius: 8px; border: 1px solid #333; margin-bottom: 30px;">
                    <h3 style="margin-top: 0; color: #90a4c2; font-size: 12px; text-transform: uppercase; letter-spacing: 1px; margin-bottom: 20px;">Summary of Requirements</h3>
