    ...
    <>
      ...
      <div className="bg-[#0a0a0c] min-h-screen">
        <div className="max-w-7xl mx-auto px-6 py-20 flex flex-col lg:flex-row gap-16">
          ...
          {/* Sidebar (Desktop TOC) */}
          <aside className="hidden lg:block w-72 shrink-0 self-start z-10" style={{ position: 'sticky', top: '160px' }}>
          ...
          <div className="max-w-7xl mx-auto px-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              {service.relatedServices.map((rel, i) => (
                <Link key={i} href={`/services/${rel.slug}`} className="block p-8 rounded-2xl bg-white/5 border border-white/10 hover:border-malibu/50 hover:bg-white/10 transition-all group">
                  {rel.icon && (
                  ...
                  <h3 className="text-xl font-bold text-white mb-3 group-hover:text-malibu transition-colors">{rel.title}</h3>
